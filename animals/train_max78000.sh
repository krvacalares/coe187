...
python train.py --epochs 50 --optimizer Adam --lr 0.001 --wd 0 --deterministic \
--model ai85cdnet --dataset animals --confusion --param-hist --embedding \
--device MAX78000 --workers 0 --enable-tensorboard
