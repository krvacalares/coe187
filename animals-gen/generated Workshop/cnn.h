...
/*
 * This header file was automatically @generated for the animals-gen network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 51,372,032 ops (50,435,072 macc; 936,960 comp; 0 add; 0 mul; 0 bitwise)
    ...
    Layer 6: 5,120 ops (5,120 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 60,848 bytes out of 442,368 bytes total (13.8%)
  Bias memory:   5 bytes out of 2,048 bytes total (0.2%)
*/
